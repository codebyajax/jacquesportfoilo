...
export default function VerifiedBadge({ color }: Props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="tick" style={{ fill: color }} role="img" aria-label="Verified account">
