const HORMOZI_URL = "https://www.acquisition.com";

export default function Quote() {
    return (
        <section aria-label="Inspirational quote" className="quote-section padding">
            <figure className="quote-figure">
                <a href={HORMOZI_URL} target="_blank" rel="noopener noreferrer" aria-label="Visit Alex Hormozi's website" className="quote-mark-link">
