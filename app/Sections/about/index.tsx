...
export default function About() {
    return (
        ...
        >
            ...
            <p className="mt-4">
                Recently he's been working on an archietectural and semanti based development tool called &nbsp;<Link href={''}>
                    <b>@FORGE.</b>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#fdc100" viewBox="0 0 20 20" className="inline size-5 mb-[5]"
                ...
                </Link>, that'll completely change how developers, students and vibecoders use, create and manage Projects and components.
            </p>

            <div role="button" aria-label="Contact actions" className="mt-4">
                <Link href={"mailto:jackthe1first@gmail.com"} className="hover-button">
