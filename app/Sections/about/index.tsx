...
export default function About() {
    return (
        ...
        >
            ...
            <p className="mt-4">
                Recently he's been working on an archietectural and semantic based development tool called &nbsp;<Link href={''}>
                    <b>@FORGE</b>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#fdc100" viewBox="0 0 20 20" className="inline size-5 mb-[5] stroke-0"
                ...
                </Link>, that'll completely change how students, vibecoders and developers use, create and manage projects.
            </p>

            <div role="button" aria-label="Download CV" className="mt-4">
                <a
                    href="/assets/cv/Jacques-Azianou-CV.pdf"
                    download="Jacques-Azianou-CV.pdf"
