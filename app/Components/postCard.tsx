...
export default function PostCard({ id, title, date, claps = 0, tags = [] }: PostCardProps) {
    ...
    return (
        <article className="post-card">
            <Link
                ...
                aria-label={`${title} — posted on ${date}${claps ? `, ${claps} claps` : ""}${tags.length ? `, tagged ${tags.join(", ")}` : ""}. Opens in new tab.`}
            ...
            >
                <div className="post-card-body">
                    ...
                    <div className="post-card-date" aria-hidden="true">
                        <svg stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" height="14" width="14" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                        ...
                        <p className="post-card-date-text">{date}</p>
                    </div>

                    <span className="post-card-meta" aria-hidden="true">
                        {claps > 0 && (
                            <div className="post-card-claps">
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 256 256" height="14" width="14" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                                ...
                                <p className="post-card-date-text">{claps}</p>
                            </div>
                        )}
                        ...
                        {tags.length > 0 && (
                            <div className="post-card-tags">
                                {tags.map((tag) => (
                                    <span key={tag} className="cont">{tag}</span>
                                ))}
                            </div>
                        )}
                    </span>
                ...
                <div className="post-card-arrow" aria-hidden="true">
                    <svg
                        ...
                        className="post-card-arrow-icon"
                        height="18"
                        width="18"
